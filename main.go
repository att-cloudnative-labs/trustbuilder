...
import (
	...
	"github.com/att-cloudnative-labs/trustbuilder/controllers"
...
func init() {
	...
	utilruntime.Must(trustbuilderv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "28bda54b.directv.com",
	...
	if err = (&controllers.CertificatePackageReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "CertificatePackage")
		os.Exit(1)
	}
